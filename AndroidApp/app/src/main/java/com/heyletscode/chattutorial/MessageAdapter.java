    ...
    public int getItemViewType(int position) {
        ...
        try {
            if (message.getBoolean("isSent")) {
                JSONObject bodyObject = message.getJSONObject("body");
        ...
        try {
            if (message.getBoolean("isSent")) {
                ...
                if (bodyObject.has("message")) {
                    ...
                    messageHolder.messageTxt.setText(bodyObject.getString("message"));
                ...
                if (bodyObject.has("message")) {
                    ...
                    messageHolder.nameTxt.setText(bodyObject.getString("displayName"));
                    messageHolder.messageTxt.setText(bodyObject.getString("message"));
